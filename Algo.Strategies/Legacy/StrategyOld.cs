...
public partial class StrategyOld : BaseLogReceiver, INotifyPropertyChangedEx, IMarketRuleContainer,
	...
	IPortfolioProvider, IPositionProvider, IReportSource, IStrategy
{
	...
	{
		public StrategyOld Strategy { get; } = strategy ?? throw new ArgumentNullException(nameof(strategy));
	...
	{
		private readonly StrategyOld _strategy = strategy ?? throw new ArgumentNullException(nameof(strategy));
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="StrategyOld"/>.
	/// </summary>
	public StrategyOld()
	{
...
#pragma warning restore CS0618 // Type or member is obsolete
	...
	protected void RaiseProcessStateChanged(StrategyOld strategy)
	{
		if (strategy == null)
	...
	/// </summary>
	public event Action<StrategyOld> IsOnlineChanged;
...
#pragma warning restore CS0618
	...
	/// <param name="strategy">Strategy.</param>
	/// <param name="error">Error.</param>
	protected virtual void OnError(StrategyOld strategy, Exception error)
	{
	...
	/// <inheritdoc />
	public virtual StrategyOld Clone()
	{
	...
	/// </summary>
	/// <returns><see cref="StrategyOld"/></returns>
	protected virtual StrategyOld CreateClone()
		=> GetType().CreateInstance<StrategyOld>();

	/// <summary>
	/// Copy settings into <paramref name="copy"/>.
	/// </summary>
	/// <param name="copy"><see cref="StrategyOld"/></param>
	protected virtual void CopyTo(StrategyOld copy)
	{
		if (copy is null)
